        ...
        [MOVEMENTKIND_PLAYER] =
            {
                ...
                [MOVE_WALK]     = {.speed = 6.5f, .accell = 30.0f, .friction = 10.0f, .gravity = -13.0f},
                [MOVE_CROUCH]   = {.speed = 4.0f, .accell = 20.0f, .friction = 10.0f, .gravity = -13.0f},
                [MOVE_FALL]     = {.speed = 10.0f, .accell = 2.0f, .friction = 0.1f, .gravity = -13.0f},
                [MOVE_JUMP]     = {.speed = 6.0f, .accell = 3.0f, .friction = 0.1f, .gravity = -13.0f},
                [MOVE_WALLJUMP] = {.speed = 4.0f, .accell = 2.0f, .friction = 0.5f, .gravity = -13.0f},
