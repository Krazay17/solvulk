        ...
        [MOVEMENTKIND_PLAYER] =
            {
                ...
                [MOVE_WALK]     = {.speed = 6.5f, .accell = 25.0f, .friction = 8.0f, .gravity = -9.81f},
                [MOVE_CROUCH]   = {.speed = 4.0f, .accell = 15.0f, .friction = 8.0f, .gravity = -9.81f},
                [MOVE_FALL]     = {.speed = 4.0f, .accell = 5.0f, .friction = 0.1f, .gravity = -9.81f},
                [MOVE_JUMP]     = {.speed = 5.0f, .accell = 8.0f, .friction = 0.1f, .gravity = -9.81f},
                [MOVE_WALLJUMP] = {.speed = 4.0f, .accell = 1.0f, .friction = 0.5f, .gravity = -9.81f},
                [MOVE_WALLRUN]  = {.speed = 7.0f, .accell = 6.0f, .friction = 1.0f, .gravity = -1.0f},
                [MOVE_SLIDE]    = {.speed = 3.5f, .accell = 1.0f, .friction = 0.5f, .gravity = -9.81f},
