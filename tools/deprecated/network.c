        ...
        case ENET_EVENT_TYPE_CONNECT: {
            ...
            else if (solNet.role == NETROLE_CLIENT)
            {
                ...
                NetHelloPacket hello = {
                    ...
                    .startPos        = Sol_Comp_Get(Sol_GetActiveGameWorld(), 1, SolXform)->pos,
...
void Net_Recv_Packet(ENetEvent *event)
{
    ...
    case NET_PACKET_HELLO: {
        ...
        solNet.players[slot].currentWorldId = Sol_GetActiveGameWorldId();
        solNet.players[slot].lastPing       = solState.gameTime;

        NetWelcomePacket welcomePacket = {
            .type        = NET_PACKET_WELCOME,
            .currentTick = solState.tickCounter,
            .playerId    = id,
            .worldId     = Sol_GetActiveGameWorldId(),
        };
    ...
    case NET_PACKET_WELCOME: {
        ...
        if (Sol_Comp_Has(world, Sol_Player_GetEnt(world, 0), SolAbility))
        {
    ...
    case NET_PACKET_HEARTBEAT:
        solNet.players[(int)(intptr_t)event->peer->data].lastPing = solState.gameTime;
        break;
    ...
    case NET_PACKET_INPUT: {
        ...
        // CompController *c           = Sol_Controller_Get(world, id);
